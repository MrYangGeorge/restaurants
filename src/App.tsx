...
const GoffeeCoffeeApp = () => {
  ...
  const menu = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          priceHot: 6000,
          priceIced: 6000,
          description: "Sweet creamy latte with condensed milk",
        },
        {
          id: 105,
          name: "Americano",
      ...
      items: [
        {
          ...
          name: "Dirty Latte",
          priceIced: 6000,
          description: "Espresso shots over cold milk",
        },
        {
          id: 202,
          name: "Sicily",
          priceIced: 6000,
          description: "Refreshing citrus coffee blend",
        },
        {
          id: 203,
          name: "Tonpresso",
        ...
        },
        {
          ...
          name: "Ice Drip",
          priceIced: 6000,
          description: "Slow-dripped concentrated coffee",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          name: "Honey Process",
          priceHot: 8000,
          description: "Sweet and fruity notes",
        },
        {
          id: 303,
          name: "Natural Process",
          priceHot: 8000,
          description: "Bold and complex flavors",
        },
        {
          id: 304,
          name: "Special Process",
          priceHot: 10000,
          description: "Exclusive processing method",
        },
      ],
    },
    {
      ...
      items: [
        {
          id: 401,
          name: "Lemonade Sparkling",
          priceIced: 6000,
          description: "Refreshing fizzy lemonade",
        },
        {
          id: 402,
          name: "Matcha",
        ...
        },
        {
          ...
          priceHot: 4000,
          priceIced: 4000,
          description: "Fresh steamed or iced milk",
        },
      ],
    },
  ];
  ...
  const confirmAddToCart = (temperature: string) => {
    ...
    const price =
      temperature === "hot" ? selectedItem.priceHot : selectedItem.priceIced;
  ...
  const removeFromCart = (id: number, temperature: string) => {
    setCart(
      cart.filter(
        (item: any) => !(item.id === id && item.temperature === temperature)
      )
    );
  };
      ...
      <div className="max-w-4xl mx-auto p-4 pb-24">
        {menu.map((category) => (
          <div key={category.id} className="mb-8">
            <h2
              className="text-2xl font-bold italic mb-4 px-2 pb-2"
              style={{ fontFamily: "Georgia, serif" }}
            >
              {category.category}
            </h2>
            <div className="grid grid-cols-1 gap-3">
              {category.items.map((item) => (
                <div
                  key={item.id}
                  className="bg-gray-50 rounded-2xl shadow-md p-4 hover:shadow-xl transition border border-gray-200"
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <button
                      ...
                      className="bg-black hover:bg-gray-800 text-white p-2 rounded-full transition shadow-md shrink-0 mt-1"
                    >
              ...
              {cart.length === 0 ? (
                ...
                <div className="space-y-4">
                  {cart.map((item: any, index: number) => (
                    <div
                      key={`${item.id}-${item.temperature}-${index}`}
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 justify-end">
                        <button
                          onClick={() =>
                            updateQuantity(item.id, item.temperature, -1)
                          }
      ...
      {selectedItem && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl shadow-2xl p-6 max-w-md w-full">
            <h3
              className="text-2xl font-bold text-black mb-2 italic"
              style={{ fontFamily: "Georgia, serif" }}
            >
              {selectedItem.name}
            </h3>
